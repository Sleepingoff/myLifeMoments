const movingBox = document.querySelector("ul.wrap");
const boxWrap = document.querySelector("div.boxwrap");
//html 태그 추가하기
...
$("div.boxwrap button").click(function () {
  ...
  $(movingBox).css({
    transform: "translateX(" + (clickCount * boxSize + middleDistance) + "px)",
  });
